/*! alertifyjs - v1.7.1 - Mohammad Younes <Mohammad@alertifyjs.com> (http://alertifyjs.com) */ ! function(a) {
    "use strict";
    ...
    var n = {
        ...
        t = function() {
            function m(a) {
                if (!a.__internal) {
                    delete a.__init, a.__settings || (a.__settings = h(a.settings)), null === ya && document.body.setAttribute("tabindex", "0");
                    var c;
            ...
            function u() {
                ...
                0 === a ? c(document.body, Ba.noOverflow) : a > 0 && document.body.className.indexOf(Ba.noOverflow) < 0 && b(document.body, Ba.noOverflow)
            }

            function w(a, d, e) {
                "string" == typeof e && c(a.elements.root, Ba.prefix + e), b(a.elements.root, Ba.prefix + d), ya = a.elements.root.offsetWidth
            }

            function x(a) {
                a.get("modal") ? (c(a.elements.root, Ba.modeless), a.isOpen() && (oa(a), M(a), u())) : (b(a.elements.root, Ba.modeless), a.isOpen() && (na(a), M(a), u()))
            }
            ...
            function A(a, b) {
                ...
                return document.body.lastChild !== b.elements.root && (document.body.appendChild(b.elements.root), p.splice(p.indexOf(b), 1), p.push(b), V(b)), !1
            }
            ...
            function B(a, d, e, f) {
                switch (d) {
                    ...
                    case "transition":
                        ...
                        break;
                    case "padding":
                        f ? c(a.elements.root, Ba.noPadding) : a.elements.root.className.indexOf(Ba.noPadding) < 0 && b(a.elements.root, Ba.noPadding);
                        break;
                    case "overflow":
                        f ? c(a.elements.root, Ba.noOverflow) : a.elements.root.className.indexOf(Ba.noOverflow) < 0 && b(a.elements.root, Ba.noOverflow);
                        break;
                    case "transition":
                        w(a, f, e)
                }
            ...
            function N(a) {
                a.get("pinned") ? (c(a.elements.root, Ba.unpinned), a.isOpen() && L(a)) : (b(a.elements.root, Ba.unpinned), a.isOpen() && !a.isModal() && K(a))
            }
            ...
            function T(a) {
                ...
                var b = p[p.length - 1],
                    c = a.keyCode;
                return 0 === b.__internal.buttons.length && c === n.ESC && b.get("closable") === !0 ? (D(b), !1) : xa.indexOf(c) > -1 ? (R(b, function(a) {
                    return a.key === c
                }), !1) : void 0
            }
            ...
            function U(a) {
                ...
                } else if (c < n.F12 + 1 && c > n.F1 - 1 && xa.indexOf(c) > -1) return a.preventDefault(), a.stopPropagation(), R(b, function(a) {
                    return a.key === c
                }), !1
            }
            ...
            function W(a, b) {
                ...
                if (b && b.isModal()) {
                    ...
                    f && (b.get("maximizable") ? d = b.elements.commands.maximize : b.get("closable") && (d = b.elements.commands.close)), void 0 === d && ("number" == typeof b.__internal.focus.element ? e === b.elements.reset[0] ? d = b.elements.buttons.auxiliary.firstChild || b.elements.buttons.primary.firstChild : f && (d = b.elements.reset[0]) : e === b.elements.reset[0] && (d = b.elements.buttons.primary.lastChild || b.elements.buttons.auxiliary.lastChild)), V(b, d)
                }
            }

            function X(a, b) {
                clearTimeout(b.__internal.timerIn), V(b), t(), Da = !1, l("onfocus", b), r(b.elements.dialog, s.type, b.__internal.transitionInHandler), c(b.elements.root, Ba.animationIn)
            }
            ...
            function $(a, b) {
                var c = a[Ha] - Fa,
                    d = a[Ia] - Ga;
                Ka && (d -= document.body.scrollTop), b.style.left = Math.min(Ja.maxLeft, Math.max(Ja.minLeft, c)) + "px", Ka ? b.style.top = Math.min(Ja.maxTop, Math.max(Ja.minTop, d)) + "px" : b.style.top = Math.max(Ja.minTop, d) + "px"
            }
            ...
            function _(a, c) {
                if (null === Ma && !c.isMaximized() && c.get("movable")) {
                    var d, e = 0,
                        f = 0;
                    if ("touchstart" === a.type ? (a.preventDefault(), d = a.targetTouches[0], Ha = "clientX", Ia = "clientY") : 0 === a.button && (d = a), d) {
                        var g = c.elements.dialog;
                        if (b(g, Ba.capture), g.style.left && (e = parseInt(g.style.left, 10)), g.style.top && (f = parseInt(g.style.top, 10)), Fa = d[Ha] - e, Ga = d[Ia] - f, c.isModal() ? Ga += c.elements.modal.scrollTop : c.isPinned() && (Ga -= document.body.scrollTop), c.get("moveBounded")) {
                            var h = g,
                                i = -e,
                                j = -f;
                        ...
                        return l("onmove", c), Ka = !c.isModal() && c.isPinned(), Ea = c, La(d, g), b(document.body, Ba.noSelection), !1
                    }
                }
            }
            ...
            function aa(a) {
                if (Ea) {
                    var b;
                    "touchmove" === a.type ? (a.preventDefault(), b = a.targetTouches[0]) : 0 === a.button && (b = a), b && La(b, Ea.elements.dialog)
                }
            }
            ...
            function ba() {
                if (Ea) {
                    var a = Ea;
                    Ea = Ja = null, c(document.body, Ba.noSelection), c(a.elements.dialog, Ba.capture), l("onmoved", a)
                }
            }
            ...
            function da(a) {
                a.get("movable") ? (b(a.elements.root, Ba.movable), a.isOpen() && pa(a)) : (ca(a), c(a.elements.root, Ba.movable), a.isOpen() && qa(a))
            }
            ...
            function ea(a, b, c) {
                ...
                var j = d();
                if (j && (h = document.body.offsetWidth - h, isNaN(Na) || (f = document.body.offsetWidth - f - b.offsetWidth)), b.style.height = i - g + Qa + "px", b.style.width = h - f + Qa + "px", !isNaN(Na)) {
                    var k = .5 * Math.abs(b.offsetWidth - Oa);
                    j && (k *= -1), b.offsetWidth > Oa ? b.style.left = Na + k + "px" : b.offsetWidth >= Pa && (b.style.left = Na - k + "px")
                }
            }
            ...
            function ga(a) {
                if (Ma) {
                    var b;
                    "touchmove" === a.type ? (a.preventDefault(), b = a.targetTouches[0]) : 0 === a.button && (b = a), b && ea(b, Ma.elements.dialog, !Ma.get("modal") && !Ma.get("pinned"))
                }
            }
            ...
            function ha() {
                if (Ma) {
                    var a = Ma;
                    Ma = null, c(document.body, Ba.noSelection), c(a.elements.dialog, Ba.capture), Ca = !0, l("onresized", a)
                }
            }
            ...
            function ia(a) {
                Ma = null;
                var b = a.elements.dialog;
                "none" === b.style.maxWidth && (b.style.maxWidth = b.style.minWidth = b.style.width = b.style.height = b.style.minHeight = b.style.left = "", Na = Number.Nan, Oa = Pa = Qa = 0)
            }

            function ja(a) {
                a.get("resizable") ? (b(a.elements.root, Ba.resizable), a.isOpen() && ra(a)) : (ia(a), c(a.elements.root, Ba.resizable), a.isOpen() && sa(a))
            }
            ...
            return {
                ...
                resizeTo: function(a, b) {
                    ...
                    if (!isNaN(c) && !isNaN(d) && this.get("resizable") === !0) {
                        ...
                        "none" !== f.style.maxWidth && (f.style.minWidth = (Pa = f.offsetWidth) + "px"), f.style.maxWidth = "none", f.style.minHeight = this.elements.header.offsetHeight + this.elements.footer.offsetHeight + "px", f.style.width = c + "px", f.style.height = d + "px", l("onresized", this)
                    }
                    return this
                },
                setting: function(a, b) {
                    var c = this,
                        d = C(this, this.__internal.options, function(a, b, d) {
                            B(c, a, b, d)
                        }, a, b);
                    if ("get" === d.op) return d.found ? d.value : "undefined" != typeof this.settings ? C(this, this.settings, this.settingUpdated || function() {}, a, b).value : void 0;
                    if ("set" === d.op) {
                        if (d.items.length > 0)
                            for (var e = this.settingUpdated || function() {}, f = 0; f < d.items.length; f += 1) {
                                var g = d.items[f];
                                g.found || "undefined" == typeof this.settings || C(this, this.settings, e, g.key, g.value)
                            }
                        return this
                    }
                },
